    ...
    if (rowRef.current) {
      ...
      const scrollTo =
        direction === 'left'
          ...
          : scrollLeft + clientWidth
      // clientWidth is the width of the row in pixels
      // scrollLeft is the current position of the row in pixels

      rowRef.current.scrollTo({
        left: scrollTo,
        behavior: 'smooth',
      })
      //scrollTo is the position to scroll to   //behavior is the animation
    }
  }
